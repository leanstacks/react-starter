...
Welcome to the project documentation for the React Starter project. This directory contains guides and reference materials for the project.
...
- **[shadcn Guide](./SHADCN_GUIDE.md):** Using and configuring shadcn/ui components.

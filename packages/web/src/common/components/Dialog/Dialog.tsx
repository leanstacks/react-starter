...
const Content = ({ children, className, testId = 'dialog-content' }: BaseComponentProps & PropsWithChildren) => {
  ...
  return (
    <div className={cn({ hidden: isHidden }, className)} data-testid={testId}>
      ...
      >
        <div
          className={cn('bg-background text-foreground m-4 flex max-w-140 min-w-72 flex-col gap-4 rounded-md p-6')}
 ...
 */
const Separator = ({ className, testId = 'dialog-separator' }: BaseComponentProps) => {
